...
class News(Base):
    ...
    # 定义表的额外参数，如索引
    __table_args__ = (
        # 为category_id字段创建索引，加速按分类查询
        Index("fk_news_category_idx", "category_id"),
        # 为created_at字段创建索引，加速按时间排序
    ...
    # 定义分类ID字段，作为外键关联到news_category表
